...
| Navigation PPO / B5 | reference + failure | 379/384 oracle-route; maze button 0/12; **noise-on rescore 380/384** (caveat closed) | provenance reconciled, then multi-seed/route eval **2026-09-24:** three-panel Isaac clip with a clean RTX profile + grain metric running as `21408622`. |
