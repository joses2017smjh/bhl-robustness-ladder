...
The long-form record. The [README](../README.md) is the summary.
...
Every claim below links into the [full technical report](REPORT.md), which
...
[Read §1](REPORT.md#1--domain-randomization-the-fidelity-ladder)
...
[Read §2](REPORT.md#2--push-recovery-how-hard-a-shove-is-learnable)
...
[Read §3](REPORT.md#3--rough-terrain-what-actually-buys-terrain-robustness)
...
[Read §3b](REPORT.md#3--rough-terrain-what-actually-buys-terrain-robustness)
...
[Read §6](REPORT.md#6--depth-without-a-renderer)
...
[Read §8](REPORT.md#8--do-the-arms-buy-stability-walk-the-lab-floor-and-see)
...
[Read §5](REPORT.md#5--cooperative-lift-can-two-of-them-learn-to-pick-something-up)
...
[Protocols, metric definitions, and the cluster notes](REPORT.md#how-any-of-this-is-measured)
...
does not load at all**. [The list](REPORT.md#what-was-found-in-upstream).
