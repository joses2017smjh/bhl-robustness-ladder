...
| SF-04 | Does a recurrent, modality-dropout `both` policy degrade gracefully? | **DONE.** From scratch: NEGATIVE. From the `Both` checkpoint: delay-only, dropout-only, all-ingredients fine-tunes and the distillation all succeed; bias-only unmeasured (the probe has no bias setting) | ≈16 GPU-h | All-ingredients MLP fine-tune **32 / 32 / 29 / 32 / 32 / 30** (baseline, delay 1, delay 2, LiDAR off, stereo off, both off) vs control 30 / 27 / 0 / 18 / 0 / 0; delay-only 31/32/30/24/0/0; dropout-only 30/22/1/30/32/31; bias-only 31/27/0/32/0/0; student (LSTM) 30/30/27/31/30/30. Each ingredient repairs the rows it randomizes; the recurrent-from-scratch recipe was the failure. Caveat: fixed route, Blind already 32/32 |
