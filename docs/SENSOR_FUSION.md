...
| SF-04 | Does a recurrent, modality-dropout `both` policy degrade gracefully? | From scratch: **NEGATIVE**. From the `Both` checkpoint: delay-only, dropout-only and all-ingredients fine-tunes and the distillation **all succeed** (`21404967`, `21404946`, `21404945`, `21404181`); bias-only queued | ≈14 GPU-h | **All-ingredients MLP fine-tune: 32 / 32 / 29 / 32 / 32 / 30** (baseline, delay 1, delay 2, LiDAR off, stereo off, both off) vs control 30 / 27 / 0 / 18 / 0 / 0. Delay-only: 31 / 32 / 30 / 24 / 0 / 0. Dropout-only: 30 / 22 / 1 / 30 / 32 / 31. Student (LSTM): 30 / 30 / 27 / 31 / 30 / 30. Each ingredient repairs exactly the rows it randomizes; the recurrent-from-scratch recipe was the failure. Caveat: fixed route, Blind already 32/32 |
